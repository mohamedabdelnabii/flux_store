...
class _AuthApiService implements AuthApiService {
  ...
  Future<AuthResponse> verifyResetCode(
      VerifyResetCodeRequestBody verifyResetCodeRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyResetCodeRequestBody.toJson());
    final _options = _setStreamType<AuthResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<AuthResponse> updateMe(UpdateMeRequestBody updateMeRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateMeRequestBody.toJson());
    final _options = _setStreamType<AuthResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
