...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<ReviewModel> reviews) : _reviews = reviews;
...
abstract class _Success implements ReviewsState {
  const factory _Success(final List<ReviewModel> reviews) = _$SuccessImpl;
